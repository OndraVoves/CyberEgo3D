...
namespace Ogre {
    ...
    class Euler {
        public:
             ...
             */
            explicit Euler ( const Ogre::Quaternion &quaternion ) {
                fromQuaternion ( quaternion );
            }

            explicit Euler ( const Ogre::Matrix3 &matrix ) {
                fromMatrix3 ( matrix );
            }
            ...
            /// Get the Roll angle.
            inline Ogre::Radian getRoll() const {
                return mRoll;
            }
             ...
             *  @param r New value for roll
             */
            inline Euler &setRotation ( const Ogre::Radian &y, const Ogre::Radian &p, const Ogre::Radian &r ) {
                mYaw = y;
                mPitch = p;
                mRoll = r;
                mChanged = true;
             ...
             */
            inline Euler &yaw ( const Ogre::Radian &y ) {
                mYaw += y;
                mChanged = true;
                return *this;
            }
             ...
             */
            inline Euler &pitch ( const Ogre::Radian &p ) {
                mPitch += p;
                mChanged = true;
                return *this;
            }
             ...
             */
            inline Euler &roll ( const Ogre::Radian &r ) {
                mRoll += r;
                mChanged = true;
                return *this;
            }
             ...
             *  @param r Angle to add on current roll
             */
            inline Euler &rotate ( const Ogre::Radian &y, const Ogre::Radian &p, const Ogre::Radian &r ) {
                mYaw += y;
                mPitch += p;
                mRoll += r;
                mChanged = true;
             ...
             */
            inline Euler &fromQuaternion ( const Ogre::Quaternion &quaternion ) {
                Ogre::Matrix3 rotmat;
             ...
             */
            inline Euler &fromMatrix3 ( const Ogre::Matrix3 &matrix ) {
            ...
            inline Euler &operator= ( const Ogre::Matrix3 &matrix ) {
                fromMatrix3 ( matrix );
                return *this;
            }
